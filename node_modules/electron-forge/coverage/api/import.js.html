...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">1.19% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>1/84</span>
      </div>
    </div>
  </div>
...
&nbsp;
  const confirm = <span class="cstat-no" title="statement not covered" >!interactive || (await inquirer.createPromptModule()({</span>
    type: 'confirm',
    name: 'confirm',
...
<span class="cstat-no" title="statement not covered" >    console.warn('It looks like this project is already configured for "electron-forge"'.green);</span>
    const shouldContinue = <span class="cstat-no" title="statement not covered" >!interactive || (await inquirer.createPromptModule()({</span>
      type: 'confirm',
      name: 'shouldContinue',
...
&nbsp;
  const shouldChangeMain = <span class="cstat-no" title="statement not covered" >interactive ? (await inquirer.createPromptModule()({</span>
    type: 'confirm',
...
<span class="cstat-no" title="statement not covered" >      electronName = key;</span>
      ...
      const shouldRemoveDependency = <span class="cstat-no" title="statement not covered" >!interactive || (await inquirer.createPromptModule()({</span>
        type: 'confirm',
